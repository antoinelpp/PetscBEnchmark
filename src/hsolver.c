...
void hypre_solver_( MPI_Fint *COMM, int *myid, int *period, int *topo, int *ncells, double *values, double *bb, double *xx, int *flag )
{
  //TODO : remove FLAG, that is not usefull with the two new function Allocate and deallocate
